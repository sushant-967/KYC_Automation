...
from schemas import (FinancialProfileOutput, IDVerificationOutput, RiskContributor,
...
def run_risk(screening: ScreeningOutput, idv: IDVerificationOutput,
             fin: FinancialProfileOutput) -> RiskOutput:
